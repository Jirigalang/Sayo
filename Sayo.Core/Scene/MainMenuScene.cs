    ...
    : SceneBase(graphicsDevice, content, graphicsDeviceManager)
{
    ...
    private void CreateTitlePanel()
    {
        ...
        var startButton = Helper.CreateButton(_titleScreenButtonsPanel, HandleStartClicked, "开始", Anchor.Bottom, width: 70);
        var settingButton = Helper.CreateButton(_titleScreenButtonsPanel, SettingButton_Click, "设置", Anchor.BottomRight,
            30);
